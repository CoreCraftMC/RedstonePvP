...
import me.corecraft.redstonepvp.api.enums.Keys;
...
import me.corecraft.redstonepvp.utils.ItemUtils;
        ...
        switch (menu) {
            case "beacon-menu" -> BeaconManager.getBeaconData().forEach((uuid, beacon) -> {
                ...
                final ItemBuilder itemBuilder = button.build(
                        ...
                        .setPersistentString(Keys.beacon_uuid.getNamespacedKey(), beacon.getName());
                ...
                gui.addItem(gui.asGuiItem(itemBuilder.asItemStack(), event -> {
                    ...
                    switch (event.getClick()) {
                        case LEFT -> {
                            ...
                            final String beaconName = container.get(Keys.beacon_uuid.getNamespacedKey(), PersistentDataType.STRING);
                        ...
                        case RIGHT -> {
                            ...
                            BeaconManager.getBeacon(beaconName).getDrop().getItems().forEach((key, itemDrop) -> {
                                ...
                                drop.setPersistentString(Keys.beacon_item.getNamespacedKey(), key);
                                ...
                                item_gui.addItem(item_gui.asGuiItem(drop.asItemStack(), clickEvent -> {
                                    ...
                                    final String itemName = pdc.get(Keys.beacon_item.getNamespacedKey(), PersistentDataType.STRING);
